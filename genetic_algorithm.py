...
def Population_Number_Maintenance(chromosomes,crossover_probability,mutation_probability,Population_Number, n_nodes,data,policy):
...
def main(data, Population_Number, max_generations, n_agent, n_nodes):
    ...
    for gen in range(max_generations):
        ...
        chromosomes = Population_Number_Maintenance(copy.deepcopy(chromosomes),crossover_probability,mutation_probability,Population_Number, n_nodes, data, policy)
